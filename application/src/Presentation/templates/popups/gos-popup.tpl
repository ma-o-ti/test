<div class="popup" id="gos-popup">
  <div class="popup__inner">
    <div class="popup__background js-popup-background">
      <div class="popup__container js-popup-container">
        <div class="popup__content">
          <div class="popup__header">
            <p class="popup__title headline-h3">Да, мы учувствуем в госзакупках!</p><button class="popup__close-btn js-popup-close-btn"><span class="wrap-icon"><svg class="icon"><use href="assets/img/svgSprite.svg#icon__menu-close"></use></svg></span></button>
          </div>
          <div class="popup__main">
            <figure class="quoting  quoting--form">
              <div class="quoting__row">
                <blockquote class="quoting__blockquote">Мы аккредитованы на всех федеральных и большинства региональных торговых площадках. Готовы работать на любой площадке удобной для заказчика.</blockquote>
